...
class ReminderEditionViewController: DataTableViewController, UITextFieldDelegate, LocationSelectionDelegate {
    ...
    enum Rows : String {
        case TitleRow = "Titlu"
        case DateRow = "Data"
        case DatePickerRow = "Alege Data"
        case LocationRow = "Locație"
        case SaveRow = "Salvează"
    }
    
    enum Sections : String {
        case FormSection = "Form"
        case SaveSection = "Salvează"
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case Rows.DateRow:
            ...
            titleLabel.text = "Amintește-mi la data anumită"
        ...
        case Rows.LocationRow:
            ...
            cell.textLabel?.text = "Amintește-mi la locația:"
